...
const PersonalInformation: React.FC<Props> = ({ personalInfo }) => {
    ...
    return (
        <div className="mb-40">
            <h3 className="px-2 text-md text-[#4570EA] font-semibold">
                Personal Information
            </h3>
            <div className="flex flex-col">
                {/* Kişisel bilgi alanları */}
                <div className="flex items-center space-x-5">
                    <label className="p-2 w-48">First Name:</label>
                    <div className="p-2 w-[400px]">
                        {personalInfo.first_name}
                    </div>
                </div>
                <div className="flex items-center space-x-5 ">
                    <label className="p-2 font-medium w-48">Last Name:</label>
                    <div className="p-2 w-[400px]">
                        {personalInfo.last_name}
                    </div>
                </div>
                <div className="flex items-center space-x-5">
                    <label className="p-2 font-medium w-48">Father's Name:</label>
                    <div className="p-2 w-[400px]">
                ...
                <div className="flex items-center space-x-5">
                    <label className="p-2 font-medium w-48">Nationality:</label>
                    <div className="p-2 w-[400px]">
                ...
                <div className="flex items-center space-x-5 ">
                    <label className="p-2 font-medium w-48">Date of Birth:</label>
                    <div className="p-2 w-[400px]">
                ...
                <div className="flex items-center space-x-5">
                    <label className="p-2 font-medium w-48">Address:</label>
                    <div className="p-2 w-[400px]">
                        {personalInfo.address}
                    </div>
                </div>
                <div className="flex items-center space-x-5">
                    <label className="p-2 font-medium w-48">Place of Birth:</label>
                    <div className="p-2 w-[400px]">
                ...
                <div className="flex items-center space-x-5 ">
                    <label className="p-2 font-medium w-48">Home Phone:</label>
                    <div className="p-2 w-[400px]">
                ...
                <div className="flex items-center space-x-5 ">
                    ...
                    <div className="p-2  w-[400px] h-20">
